...
<body>
    ...
    <script>
        const RESERVED_USERNAMES = <?php require_once __DIR__ . '/../tintin-core/includes/constants.php'; echo json_encode(array_map('strtolower', array_map(function($n) { return str_replace(['-', '_', ' '], '', strtolower($n)); }, TTC_USERNAME_BLACKLIST))); ?>;
